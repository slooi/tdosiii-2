...
/**
 * @param {[string,string]} shaderSources
 */
function createRenderer(shaderSources) {
	const [vSource, fSource] = shaderSources;
	...
	function drawCircles(circleArray, clear) {
		...
		if (clear) {
			...
			gl.disableVertexAttribArray(attribLocation.a_Color);
